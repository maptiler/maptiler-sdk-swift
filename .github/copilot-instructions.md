...
- Before you make the Pull Request ALWAYS run unit tests to validate the code and fix potential issues. Use the following command to run the tests: xcrun xcodebuild test -scheme MapTilerSDK -destination 'platform=iOS Simulator,name=iPhone 16,OS=18.2'
