...
public struct MTMapOptions: @unchecked Sendable {
    ...
    public var language: MTLanguage?
    ...
    public var projection: MTProjectionType?
    ...
    public var terrainIsEnabled: Bool?
    ...
    public var cancelPendingTileRequestsWhileZooming: Bool?
    ...
    public var isCenterClampedToGround: Bool?

    /// Boolean indicating whether Resource Timing API information will be collected.
    public var shouldCollectResourceTiming: Bool?
    ...
    public var crossSourceCollisionsAreEnabled: Bool?
    ...
    public var logoPosition: MTMapCorner? = .topRight
    ...
    public var maptilerLogoIsVisible: Bool? = true
    ...
    public var maxTileCacheSize: Double?
