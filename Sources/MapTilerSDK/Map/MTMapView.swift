        ...
        Task {
            do {
                ...
                if case .bool(let commandValue) = value {
                    ...
                    let trimmed = commandValue.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
                    if trimmed == "true" {
                        ...
                        completion?(
                            .failure(
                                MTError.unsupportedReturnType(description: "Expected bool, got unknown string.")
                            )
                        )
                    }
                } else {
