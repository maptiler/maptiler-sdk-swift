...
public class MTRasterTileSource: MTTileSource, @unchecked Sendable {
    ...
    ///
    /// - Note: Defaults to 512. Only configurable for raster layers.
    ...
    /// Type of the source.
    public private(set) var type: MTSourceType = .raster
